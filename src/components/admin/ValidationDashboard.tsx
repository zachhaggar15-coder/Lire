  ...
  return (
    <main className="px-4 pt-6 pb-10">
      ...
      <form onSubmit={load} className="mb-5 grid gap-3 rounded-2xl bg-cream-card p-4 shadow-card md:grid-cols-[1.5fr_1fr_1fr_1fr_1fr_auto] md:items-end">
        ...
        <button type="submit" disabled={state === "loading"} className="rounded-full bg-brand px-5 py-2.5 shadow-raised text-sm font-semibold text-cream disabled:opacity-50">

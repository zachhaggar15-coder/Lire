...
export function AndroidBetaButton({
  ...
  className = "rounded-full bg-brand px-4 py-2 shadow-raised text-sm font-semibold text-cream",
}: {
      ...
      <div>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          ...
          <button
            ...
            className="w-full rounded-full bg-brand px-4 py-3 shadow-raised text-sm font-semibold text-cream disabled:opacity-50"
          >

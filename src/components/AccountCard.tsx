        ...
        <>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              className="rounded-full bg-brand px-3 py-1.5 shadow-raised text-sm font-semibold text-white active:scale-[0.98] disabled:opacity-50"
            >
              {syncStatus.phase === "syncing" ? "Syncing..." : "Sync now"}
            </button>
            <button
              onClick={handleSignOut}
              className="rounded-full bg-cream-dark px-3 py-1.5 text-sm font-semibold text-ink-muted active:scale-[0.98]"
            >
              Sign out
            </button>
          </div>
          ...
          {sendState === "sent" ? (
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button
                ...
                className="shrink-0 rounded-xl bg-brand px-4 py-2 text-sm font-semibold text-white active:scale-[0.98] disabled:opacity-50"
              >
